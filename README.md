...
```
Please keep in mind that the deep learning interface is "work in progress"; initial documentation is available here ([doc](https://docs.acconeer.com/en/latest/deep_learning/introduction.html)).
