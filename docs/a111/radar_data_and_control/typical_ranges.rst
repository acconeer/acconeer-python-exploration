...
The range can be further increased based on the configuration of the sensor, as described in :ref:`handbook-a111-configuring`. As an example for such an optimization :numref:`tab_range_wo_lens` shows results with an added radar Fresnel lens.
