...
To increase the signal-to-noise ratio (:term:`SNR`), sampling of points may be repeated and averaged a number of times directly by the sensor itself.
...
See :ref:`rdac-a121-timing` for a detailed description of the timing within a frame.
