...
:doc:`presence algorithm</exploration_tool/algo/a121/detectors/presence_detection>`
...
- If there is a need to change the dynamics of the presence processor, do the tuning in the :doc:`presence algorithm</exploration_tool/algo/a121/detectors/presence_detection>` GUI as there is more visual feedback related to the presence algorithm. Once new parameter values has been determined, transfer them to the breathing reference application.
