...
\begin{tikzpicture}[scale=0.7]
  \draw [thin, black!30, ystep=0] (0, -4) grid (12, 5);
  \node at (0, -2) [left] {Frame timer};
  \draw [fill=lightgray, thick] (1, -2.5) rectangle ++(7, 1);

  \begin{pgfinterruptboundingbox}
    \begin{scope}
      \clip (0, -4) rectangle (12, 5);
      \draw [fill=lightgray, thick] (9, -2.5) rectangle ++(7, 1);
    \end{scope}
  ...
  \draw [fill=cblue, thick] (9, -0.5) rectangle ++(3, 1) node[midway] {$\text{F}_2$};
  \draw [very thick, decoration={brace, amplitude=4pt, mirror, raise=3pt}, decorate] (1, -2.75) -- node[below=6pt] {$T_f = 1 / f_f$} ++(7, 0);
  ...
  \draw [fill=cred, thick] (6.5, 1.5) rectangle ++(2, 1) node[midway] {R};
  ...
  \draw [very thick] (0, 3.5)
    ...
    \draw[red, very thick] (8.5, -2) circle (0.9);
\end{tikzpicture}
\end{document}
