...
from acconeer.exptool.app.old.app import GUI
from acconeer.exptool.app.old.elements.modules import MODULE_INFOS
...
def mock_handler_gui(qtbot, mocker):
    ...
    mocker.patch(
        "acconeer.exptool.app.old.app.GUI.service_help_button_handler", mock_help_button_handler
    )
    return _get_gui(qtbot)
